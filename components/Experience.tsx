      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6 md:px-10">
        ...
        <div className="text-center mb-14 md:mb-20">
          <h2 className="text-[clamp(24px,3vw,36px)] font-[var(--font-cormorant)] text-[#4F5552] leading-[1.2]">
            ...
            <span className="italic">complete peace.</span>
          </h2>
        </div>

        {/* Card */}
        <div className="relative bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-8 sm:p-10 md:p-16">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <ul className="space-y-4 text-[#5A605D] text-[16px] max-w-md">
                <li className="flex items-start justify-center gap-3">
                  <span className="text-[#7E8C7A] mt-[3px]">✓</span>
          ...
          <div className="hidden md:block absolute top-16 bottom-16 left-1/2 w-px bg-[#E8E3DA]" />
